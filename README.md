...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dtool_ibeis-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dtool_ibeis-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add dtool_ibeis
# for installing globally
pixi global install dtool_ibeis
```
...
It is possible to list all of the versions of `dtool_ibeis` available on your platform:
...
```
pixi search dtool_ibeis --channel conda-forge
```
